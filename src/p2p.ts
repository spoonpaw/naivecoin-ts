        ...
        try {
            ...
            switch (message.type) {
                ...
                case MessageType.RESPONSE_BLOCKCHAIN: {
                    const receivedBlocks: Block[] | null = JSONToObject<Block[]>(String(message.data));
                ...
                case MessageType.RESPONSE_TRANSACTION_POOL: {
                    const receivedTransactions: Transaction[] | null = JSONToObject<Transaction[]>(String(message.data));
...
export {connectToPeers, broadcastLatest, broadCastTransactionPool, initP2PServer, getSockets, isExtendedWebSocket};
